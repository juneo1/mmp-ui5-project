sap.ui.define([
	...
	"use strict";
	return Controller.extend("Plant_Docu.controller.Doc3", {
		onInit: function() {
			var oData = {
				oToday: null,
				oToday2: null,
			...
			this.getView().byId("filterBar3")._oSearchButton.setText("검색");
			this.callRfc3({});
		},
		...
		onGetList: function(oEvent) { //SEARCH
			...
			if (sDocNum) {
				aFliterbarFilter.push(new Filter("MVNR", FilterOperator.EQ, sDocNum));
			}
		...
		callRfc3: function(oResult) { //230
			...
			this.getOwnerComponent().rfcCall("ZMPI247", {
				...
				var oModel2 = new JSONModel(oResultData.TAB1);
